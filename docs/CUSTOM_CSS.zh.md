...
自定义 CSS 在应用启动时统一加载，没有打开文章时也会生效；切换订阅源、关闭阅读视图不会移除主题。替换或删除 CSS 后立即更新，不需要外部主题服务。

可使用应用的颜色变量分别定制亮色、暗色主题；只希望影响正文的规则请限定在 `.prose-content` 下。原有文章样式继续兼容。
...
MrRSS 允许您通过上传自己的 CSS 文件来自定义界面和文章内容的外观。此功能使您能够：
